...
const CTA = () => {
    ...
    return (
        <section ref={containerEl} className="flex items-center justify-center bg-primary/10">
            <Container className="py-12 md:py-10">
                <div className="flex items-center justify-between w-full max-w-7xl flex-col md:flex-row gap-10 md:gap-20">
                    <div className="container-1 flex flex-col items-start gap-5 md:gap-10">
                    ...
                    <div className="container-2 flex-1 flex items-center justify-center shadow-2xl shadow-primary/40 w-full h-full md:h-96 rounded-xl">
